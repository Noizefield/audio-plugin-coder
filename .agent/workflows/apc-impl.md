...
**Preferred model:** Read `apc.config.json` -> `models.phases.impl` (announce to user; switch host model if possible).
...
**Execute Skill:**
Load and execute `..agent\skills\impl\SKILL.md`
...
Next step: /apc-test [Name] or /apc-ship [Name]
```
