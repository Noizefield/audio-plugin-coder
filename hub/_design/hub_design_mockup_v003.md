...
a{color:var(--ink);}
/* == shell.css: sidebar + single-section switching (CSS-only) == */
...
<pre class="mark">+------------------+
| APC/HUB_         |
| <span class="mut">v003 · DRAFT</span>     |
+------------------+</pre>
...
<footer class="mono">
=== APC HUB v003 ============================================================<br>
snapshot baked 2026-09-13 · sidebar shell · one section at a time · dark default · amber = active/warn · phosphor green = ok/good · zero deps, system fonts, no images
</footer>
</div>
