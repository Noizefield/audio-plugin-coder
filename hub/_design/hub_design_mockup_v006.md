# APC Hub - Mockup v006 (review record)

Spec: `hub_design_spec_v006.md` · Status: DRAFT · Snapshot baked: 2026-09-13
Twin runnable file: `hub_design_mockup_v006.html` (same folder - open via
`file://`, zero deps, system fonts, no images).
Changes vs v005: header is now STICKY (survives scroll inside long sections;
opaque paper background, z-index above sidebar); `10 DOCS` renamed
`10 DOCUMENTATION` and rebuilt as a doc center - disabled-search placeholder,
16 `<details>` collapsers with the REAL baked `##` chapter index per file,
reader preview box with REAL `docs/README.md` excerpt text; header gains 4th
badge `APC v1.4.0`. Tokens, data, switching otherwise unchanged.

Review questions for v006 are asked in chat (no checklists in mockup files).
...
<title>APC HUB v006 // mockup - snapshot 2026-09-13</title>
<style>
...
/* == docs.css: search dummy, collapsers, reader preview == */
...
details.doc .full{color:var(--muted); font-size:12.5px; margin:6px 0 2px;}
...
<p class="mono pager"><a href="#10-documentation">&lt; PREV</a> <span class="mut">|</span> <span class="mut">END</span></p>
</section>

</main>
<footer class="mono">
=== APC HUB v006 ============================================================<br>
snapshot baked 2026-09-13 · sticky header · documentation center (real index) · APC v1.4.0 + update-check spec §10 · dark default · amber = active/warn · phosphor green = ok/good · zero deps, system fonts, no images
</footer>
</div>
