# APC Hub - Mockup v008 (review record)

Spec: `hub_design_spec_v008.md` · Status: DRAFT · Snapshot baked: 2026-09-13
Twin runnable file: `hub_design_mockup_v008.html` (same folder - open via
`file://`, zero deps, system fonts, no images).
Changes vs v007: FIXED SHELL - header + sidebar are viewport-locked
(`body{overflow:hidden}`, flex column frame); ONLY the right content region
scrolls. Replaces the sticky-overlap construction. Mobile (<=900px) falls
back to page scroll with sticky header. Decided: no submenu auto-expand, no
new JavaScript. Content, tokens, data unchanged.
...
<title>APC HUB v008 // mockup - snapshot 2026-09-13</title>
<style>
...
body{background:var(--paper); color:var(--ink);
  ...
  font-size:15px; line-height:1.5; margin:0; overflow:hidden;}
.mono,pre,table,code,.kicker,.side{font-family:Consolas,"Cascadia Mono",Menlo,monospace;}
a{color:var(--ink);}
/* == shell.css: FIXED shell - header+sidebar locked, content scrolls (spec §4.5) == */
.frame{max-width:1340px; margin:0 auto; height:100vh; height:100dvh;
  display:flex; flex-direction:column;
  border-left:2px solid var(--rule); border-right:2px solid var(--rule);}
.topbar{display:flex; gap:28px; align-items:center; flex-wrap:wrap; flex:none;
  border-bottom:2px solid var(--rule); padding:20px 24px 16px;}
.topbar pre.logo{font-size:13px; line-height:1.25; margin:0; overflow-x:auto;}
.topbar pre.logo .amber{color:var(--amber); font-weight:bold;}
.topmeta .titleline{font-size:20px; font-weight:700; margin:0 0 8px;}
.topmeta .badges{margin:0; font-size:12px;}
.badge{display:inline-block; border:1px solid var(--rule); padding:1px 8px;
  font-size:12px; margin:0 8px 6px 0;}
.badge.ok{background:var(--good); border-color:var(--good);
  color:var(--good-ink); font-weight:bold;}
.shell{display:grid; grid-template-columns:264px 1fr; flex:1 1 auto; min-height:0;}
...
.siderel{margin:0 0 4px; font-size:12px;}
...
details.navsub{margin-bottom:2px;}
details.navsub summary{display:block; padding:3px 8px; cursor:pointer;
  border:1px solid transparent; list-style:none;}
details.navsub summary::-webkit-details-marker{display:none;}
details.navsub summary::before{content:"+ ";}
details.navsub[open] summary::before{content:"- ";}
details.navsub summary:hover{border-color:var(--rule);}
details.navsub a{padding-left:20px; font-size:12.5px;}
...
.content{padding:8px 24px 0; max-width:884px; overflow-y:auto; min-height:0;}
...
body:has(section[id="10-documentation"]:target) a[href="#10-documentation"],
body:has(section[id="11-consistency"]:target) a[href="#11-consistency"],
body:has(section[id="doc-readme"]:target) a[href="#doc-readme"],
body:has(section[id="doc-build-system"]:target) a[href="#doc-build-system"],
body:has(section[id="doc-codex-compatibility"]:target) a[href="#doc-codex-compatibility"],
body:has(section[id="doc-codex-orchestration"]:target) a[href="#doc-codex-orchestration"],
body:has(section[id="doc-command-reference"]:target) a[href="#doc-command-reference"],
body:has(section[id="doc-faq"]:target) a[href="#doc-faq"],
body:has(section[id="doc-github-actions"]:target) a[href="#doc-github-actions"],
body:has(section[id="doc-icon-management-guide"]:target) a[href="#doc-icon-management-guide"],
body:has(section[id="doc-installer-creation"]:target) a[href="#doc-installer-creation"],
body:has(section[id="doc-model-routing"]:target) a[href="#doc-model-routing"],
body:has(section[id="doc-plugin-development-lifecycle"]:target) a[href="#doc-plugin-development-lifecycle"],
body:has(section[id="doc-project-structure"]:target) a[href="#doc-project-structure"],
body:has(section[id="doc-ship-workflow"]:target) a[href="#doc-ship-workflow"],
body:has(section[id="doc-state-management-deep-dive"]:target) a[href="#doc-state-management-deep-dive"],
body:has(section[id="doc-troubleshooting-guide"]:target) a[href="#doc-troubleshooting-guide"],
body:has(section[id="doc-webview-framework"]:target) a[href="#doc-webview-framework"]{
  background:var(--ink); color:var(--paper); font-weight:bold;}
body:has(section[id="10-documentation"]:target) details.navsub summary,
body:has(section[id^="doc-"]:target) details.navsub summary{
  background:var(--ink); color:var(--paper); font-weight:bold;}
...
body:has(section[id="10-documentation"]:target) a[href="#10-documentation"]::before,
body:has(section[id="11-consistency"]:target) a[href="#11-consistency"]::before,
body:has(section[id="doc-readme"]:target) a[href="#doc-readme"]::before,
body:has(section[id="doc-build-system"]:target) a[href="#doc-build-system"]::before,
body:has(section[id="doc-codex-compatibility"]:target) a[href="#doc-codex-compatibility"]::before,
body:has(section[id="doc-codex-orchestration"]:target) a[href="#doc-codex-orchestration"]::before,
body:has(section[id="doc-command-reference"]:target) a[href="#doc-command-reference"]::before,
body:has(section[id="doc-faq"]:target) a[href="#doc-faq"]::before,
body:has(section[id="doc-github-actions"]:target) a[href="#doc-github-actions"]::before,
body:has(section[id="doc-icon-management-guide"]:target) a[href="#doc-icon-management-guide"]::before,
body:has(section[id="doc-installer-creation"]:target) a[href="#doc-installer-creation"]::before,
body:has(section[id="doc-model-routing"]:target) a[href="#doc-model-routing"]::before,
body:has(section[id="doc-plugin-development-lifecycle"]:target) a[href="#doc-plugin-development-lifecycle"]::before,
body:has(section[id="doc-project-structure"]:target) a[href="#doc-project-structure"]::before,
body:has(section[id="doc-ship-workflow"]:target) a[href="#doc-ship-workflow"]::before,
body:has(section[id="doc-state-management-deep-dive"]:target) a[href="#doc-state-management-deep-dive"]::before,
body:has(section[id="doc-troubleshooting-guide"]:target) a[href="#doc-troubleshooting-guide"]::before,
body:has(section[id="doc-webview-framework"]:target) a[href="#doc-webview-framework"]::before{
  content:"> ";}
/* == layout.css == */
.titleline{font-size:20px; font-weight:700;}
...
.full{color:var(--muted); font-size:12.5px; margin:6px 0 2px;}
/* == docs.css: search dummy, collapsers, chapters, reader preview == */
.docsearch{width:100%; font:inherit; font-size:13px; background:transparent;
  color:var(--muted); border:1px solid var(--rule); padding:8px 12px; margin:0 0 14px;}
details.doc{border:1px solid var(--rule); margin:0 0 6px; padding:8px 12px;}
details.doc summary{cursor:pointer; font-size:13.5px;}
details.doc summary{list-style:none;}
details.doc summary::-webkit-details-marker{display:none;}
details.doc summary::before{content:"+ "; font-weight:bold;}
details.doc[open] summary::before{content:"- "; font-weight:bold;}
details.doc summary .p{color:var(--muted); font-size:12.5px;}
details.doc ol{margin:8px 0 4px; padding-left:22px; font-size:13px;}
details.doc ol li{margin-bottom:2px;}
ol.chap{margin:8px 0 12px; padding-left:22px; font-size:13px;}
ol.chap li{margin-bottom:2px;}
.reader{border:1px solid var(--rule); border-top:3px solid var(--good);
  padding:14px 16px; margin:16px 0;}
.reader h4{font-size:16px; margin:0 0 8px;}
.reader h5{font-size:14px; margin:14px 0 6px;}
.reader p, .reader li{font-size:14px;}
.reader ol{padding-left:22px; margin:6px 0;}
@media(max-width:900px){
  body{overflow:auto;}
  .frame{display:block; height:auto;}
  .topbar{position:sticky; top:0; z-index:60; background:var(--paper);}
  .shell{grid-template-columns:1fr;}
  .side{position:static; height:auto; overflow:visible; border-right:none; border-bottom:2px solid var(--rule);}
  .sidenav a{display:inline-block; margin:0 8px 6px 0;}
  .content{overflow:visible;}
  .topbar pre.logo{font-size:2.2vw; min-width:560px;}
...
<div class="topmeta">
<p class="titleline">APC HUB <span class="mut">// read-only command center</span></p>
<p class="mono badges"><span class="badge ok">[OK] SETUP 2026-08-14 / WINDOWS</span><span class="badge">PROFILE: BALANCED</span><span class="badge">SNAP 2026-09-13</span><span class="badge">APC v1.4.0</span></p>
</div>
</header>
...
<pre class="mark">+--------------------+
| APC v1.4.0         |
| <span class="mut">v008 · DRAFT</span>       |
+--------------------+</pre>
<p class="siderel mono">REL v1.4.0 <span class="mut">(PKG)</span><br>UPSTREAM <span class="mut">[..] APP-CHECK</span></p>
<nav class="sidenav">
<a href="#01-overview">01 OVERVIEW</a><a href="#02-projects">02 PROJECTS</a><a href="#03-skills">03 SKILLS</a><a href="#04-commands">04 COMMANDS</a><a href="#05-designs">05 DESIGNS</a><a href="#06-scripts">06 SCRIPTS</a><a href="#07-templates">07 TEMPLATES</a><a href="#08-tools">08 TOOLS</a><a href="#09-settings">09 SETTINGS</a>
<details class="navsub">
<summary>10 DOCUMENTATION</summary>
<a href="#10-documentation">INDEX (ALL DOCS)</a>
<a href="#doc-readme">README</a>
<a href="#doc-build-system">BUILD</a>
<a href="#doc-codex-compatibility">CODEX COMPAT</a>
<a href="#doc-codex-orchestration">CODEX ORCH</a>
<a href="#doc-command-reference">COMMANDS</a>
<a href="#doc-faq">FAQ</a>
<a href="#doc-github-actions">ACTIONS</a>
<a href="#doc-icon-management-guide">ICONS</a>
<a href="#doc-installer-creation">INSTALLER</a>
<a href="#doc-model-routing">MODELS</a>
<a href="#doc-plugin-development-lifecycle">LIFECYCLE</a>
<a href="#doc-project-structure">STRUCTURE</a>
<a href="#doc-ship-workflow">SHIP</a>
<a href="#doc-state-management-deep-dive">STATE</a>
<a href="#doc-troubleshooting-guide">TROUBLESHOOT</a>
<a href="#doc-webview-framework">WEBVIEW</a>
</details>
<a href="#11-consistency">++ CONSISTENCY</a>
</nav>
...
<p class="mono pager"><a href="#08-tools">&lt; PREV</a> <span class="mut">|</span> <a href="#10-documentation">NEXT &gt;</a></p>
</section>
...
<li>§ Root CMakeLists.txt</li>
<li>§ Plugin CMakeLists.txt</li>
<li>§ Build Scripts</li>
<li>§ Build Targets</li>
...
<li>§ Repo Skill vs Plugin</li>
<li>§ Design Notes</li>
<li>§ Official Codex References</li>
</ol>
...
<li>§ Config (`models.codex`)</li>
<li>§ Project agents</li>
<li>§ Runner</li>
<li>§ Smoke proof (after usage-window reset)</li>
<li>§ Helpers</li>
<li>§ Design notes</li>
</ol>
...
<li>§ Overview</li>
<li>§ Codex Commands</li>
<li>§ Slash Commands</li>
<li>§ Platform Scripts</li>
...
<li>§ Workflow Questions</li>
<li>§ UI Framework Questions</li>
<li>§ Build Questions</li>
<li>§ Shipping Questions</li>
<li>§ Troubleshooting</li>
<li>§ AI Agent Questions</li>
<li>§ Development Questions</li>
<li>§ Contributing Questions</li>
<li>§ Licensing Questions</li>
<li>§ Still Have Questions?</li>
...
<li>§ Method 1: CMake-Based Icon Embedding (Recommended)</li>
<li>§ Method 2: Resource File (.rc) Approach (Alternative)</li>
<li>§ Installer Desktop Shortcut Icon</li>
<li>§ Icon Design Best Practices</li>
<li>§ Testing Your Icon</li>
<li>§ Troubleshooting</li>
<li>§ Example: Complete Setup</li>
...
<li>§ macOS Installer (DMG via script, finalize on macOS)</li>
<li>§ Linux Packages (NOT IMPLEMENTED)</li>
<li>§ GitHub Actions Alternative</li>
<li>§ Troubleshooting</li>
<li>§ Summary</li>
</ol>
...
<li>§ Presets</li>
<li>§ Agent rule</li>
<li>§ Codex CLI cost routing (optional)</li>
</ol>
...
<li>§ Typography</li>
<li>§ Controls</li>
<li>§ Phase 4: IMPLEMENT (Code)</li>
<li>§ Phase 5: SHIP (Package)</li>
<li>§ State Transitions</li>
<li>§ Best Practices</li>
<li>§ Example Timeline</li>
<li>§ Related Documentation</li>
</ol>
...
<li>§ State Management</li>
<li>§ Build System</li>
<li>§ Framework-Specific Paths</li>
<li>§ Git Configuration</li>
<li>§ Local-Only &amp; Heavy Directories (kept, documented - not clutter)</li>
<li>§ Best Practices</li>
<li>§ Related Documentation</li>
</ol>
...
<li>§ Installer Features</li>
<li>§ License Agreement</li>
<li>§ State Management</li>
<li>§ Troubleshooting</li>
<li>§ Best Practices</li>
<li>§ Examples</li>
<li>§ Next Steps After Shipping</li>
<li>§ Related Documentation</li>
</ol>
...
<li>§ Overview</li>
<li>§ Architecture</li>
<li>§ Critical: Member Declaration Order</li>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#10-documentation">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-build-system">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-readme">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-codex-compatibility">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-build-system">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-codex-orchestration">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-codex-compatibility">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-command-reference">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-codex-orchestration">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-faq">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-command-reference">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-github-actions">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-faq">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-icon-management-guide">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-github-actions">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-installer-creation">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-icon-management-guide">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-model-routing">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-installer-creation">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-plugin-development-lifecycle">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-model-routing">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-project-structure">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-plugin-development-lifecycle">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-ship-workflow">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-project-structure">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-state-management-deep-dive">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-ship-workflow">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-troubleshooting-guide">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-state-management-deep-dive">&lt; PREV</a> <span class="mut">|</span> <a href="#doc-webview-framework">NEXT &gt;</a></p>
</section>
...
<p class="mono full">FULL TEXT → LIVE READER (APP)</p>
<p class="mono pager"><a href="#doc-troubleshooting-guide">&lt; PREV</a> <span class="mut">|</span> <a href="#11-consistency">NEXT &gt;</a></p>
</section>
...
<span class="good">[OK]</span> version package.json = setup.js banner (v1.4.0, dynamic)</pre>
<p class="mono pager"><a href="#doc-webview-framework">&lt; PREV</a> <span class="mut">|</span> <span class="mut">END</span></p>
</section>

</main>
<footer class="mono">
=== APC HUB v008 ============================================================<br>
snapshot baked 2026-09-13 · fixed shell (header+sidebar locked) · 16 doc sections (real index) · APC v1.4.0 + update-check spec §10 · dark default · amber = active/warn · phosphor green = ok/good · zero deps, system fonts, no images
</footer>
</div>
