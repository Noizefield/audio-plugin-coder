# APC Hub - Mockup v009 (review record)

Spec: `hub_design_spec_v009.md` · Status: DRAFT · Snapshot baked: 2026-09-13
Twin runnable file: `hub_design_mockup_v009.html` (same folder - open via
`file://`, zero deps, system fonts, no images).
Changes vs v008: FULL-BLEED SCROLL CONTAINER - `max-width` moved off the
scroll container onto an inner column (`.content>main,.content>footer`),
so the scrollbar docks at the frame's right edge instead of floating
mid-frame. Nothing else changed (6-line delta, diff-checked).
...
<title>APC HUB v009 // mockup - snapshot 2026-09-13</title>
<style>
...
.content{padding:8px 24px 0; overflow-y:auto; min-height:0;}
.content>main,.content>footer{max-width:884px;}
...
<pre class="mark">+--------------------+
| APC v1.4.0         |
| <span class="mut">v009 · DRAFT</span>       |
+--------------------+</pre>
...
<footer class="mono">
=== APC HUB v009 ============================================================<br>
snapshot baked 2026-09-13 · full-bleed scroll (scrollbar at frame edge) · 16 doc sections (real index) · APC v1.4.0 + update-check spec §10 · dark default · amber = active/warn · phosphor green = ok/good · zero deps, system fonts, no images
</footer>
</div>
