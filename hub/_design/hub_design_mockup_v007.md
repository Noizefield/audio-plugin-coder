...
a{color:var(--ink);}
/* == shell.css: centered frame + STICKY header + sidebar + switching == */
.frame{max-width:1340px; margin:0 auto; min-height:100vh;
  border-left:2px solid var(--rule); border-right:2px solid var(--rule);}
.topbar{display:flex; gap:28px; align-items:center; flex-wrap:wrap;
...
<pre class="mark">+--------------------+
| APC v1.4.0         |
| <span class="mut">v007 · DRAFT</span>       |
+--------------------+</pre>
...
<footer class="mono">
=== APC HUB v007 ============================================================<br>
snapshot baked 2026-09-13 · submenu shell · 16 doc sections (real index) · APC v1.4.0 + update-check spec §10 · dark default · amber = active/warn · phosphor green = ok/good · zero deps, system fonts, no images
</footer>
</div>
