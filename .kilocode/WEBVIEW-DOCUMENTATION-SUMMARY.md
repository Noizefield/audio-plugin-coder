...
**Location:** `..kilocode/skills/skill_design_webview/WEBVIEW-PRODUCTION-GUIDE.md`
...
**Location:** `..kilocode/skills/skill_design_webview/KNOWN-ISSUES-AND-SOLUTIONS.md`
...
#### 3. **known-issues.yaml**
**Location:** `..kilocode/troubleshooting/known-issues.yaml`
...
**Location:** `..kilocode/troubleshooting/resolutions/webview-es6-modules-fail.md`
...
2. `..kilocode/troubleshooting/known-issues.yaml` (search)
3. `..kilocode/troubleshooting/resolutions/webview-*.md` (details)

### Legacy Documentation (May Be Outdated)
- `..kilocode/skills/skill_design_webview/SKILL.md` (old guide)
