...
# Ship Phase
**Preferred model:** Read `apc.config.json` -> `models.phases.ship` (announce to user; switch host model if possible).
...
**Skill Reference:** `..kilocode/skills/apc-ship/SKILL.md`
...
**Î“Ã¥Ã† See `..kilocode/skills/apc-ship/SKILL.md`**
