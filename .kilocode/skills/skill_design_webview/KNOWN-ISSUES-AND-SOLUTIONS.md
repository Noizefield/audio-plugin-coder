...
**Reference:**
- `..kilocode/troubleshooting/resolutions/webview-011-unstyled-external-css.md`
...
5. Full write-up: `..kilocode/troubleshooting/resolutions/webview-011-unstyled-external-css.md`
...
- **`..kilocode/skills/skill_design_webview/WEBVIEW-PRODUCTION-GUIDE.md`** â­
  - COMPLETE production guide
  - Use this for all new plugins
  - Based on CloudWash development

- **`..kilocode/skills/skill_design_webview/KNOWN-ISSUES-AND-SOLUTIONS.md`** â­
  - This file
